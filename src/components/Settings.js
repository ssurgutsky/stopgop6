...
export default {
  ...
  INDEXEDDB_STORE_NAME: 'store_sg6',
  // Google Play IAP
  GP_PRODUCT1_NAME: 'com.skystairgames.sg6.coin1',
  GP_PRODUCT2_NAME: 'com.skystairgames.sg6.episodes',
  ...
  ENABLE_SPEECH: true // window.speechSynthesis !== undefined
}
